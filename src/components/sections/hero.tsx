...
export function HeroSection() {
  return (
    <section
      ...
      aria-label="Apresentação da tatuadora Fikkity"
    >
      <header className="text-center max-w-md mx-auto">
        ...
        <div className="flex justify-center gap-8 mb-16 opacity-0 animate-fade-in-delayed-2">
          <div className="text-center">
            <div className="text-2xl font-mono text-red-500 mb-1">200+</div>
          ...
          <div className="text-center">
            <div className="text-2xl font-mono text-red-500 mb-1">3+</div>
            <div className="text-xs text-gray-500 tracking-wider uppercase">
              Anos
            </div>
          </div>
        ...
        <div className="flex justify-center gap-12 mb-16 opacity-0 animate-fade-in-delayed-2">
          <Link
            href="https://instagram.com/fikkity_tattoo"
            target="_blank"
        ...
        <div className="flex flex-col gap-6 opacity-0 animate-fade-in-delayed-3">
          <Link
            href="/schedule"
